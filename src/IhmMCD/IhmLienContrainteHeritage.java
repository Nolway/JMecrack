...
/*     */ 
/*     */ 
/*     */ public class IhmLienContrainteHeritage
...
/*     */   private int cote;
/*     */   
/*     */   public IhmLienContrainteHeritage(IhmHeritage heritage, IhmEntite entite)
/*     */   {
/*  31 */     this.heritage = heritage;
/*  32 */     this.entite = entite;
/*  33 */     clLien = FormeInterneMCD.clLien;
...
/*  45 */     if (this.entite == null) {
/*  46 */       this.xCassure = 0.0D;
/*  47 */       this.yCassure = 0.0D;return;
/*     */     }
/*  49 */     this.xCassure = ((this.entite.getCentreX() + this.heritage.getCentreX()) / 2);
/*  50 */     this.yCassure = ((this.entite.getCentreY() + this.heritage.getCentreY()) / 2);
/*     */   }
/*     */   
...
/*  63 */         g.drawLine(this.entite.getCentreX(), this.entite.getCentreY(), this.heritage.getCentreX(), this.heritage.getCentreY());
/*  64 */         if (this.heritage.getEntitePere() == this.entite) dessinerfleche(g);
/*  65 */         g.drawString(getNom(), (this.entite.getCentreX() + this.heritage.getCentreX()) / 2 + 2, (this.entite.getCentreY() + this.heritage.getCentreY()) / 2 - 2);
/*     */       } else {
/*  67 */         g.setColor(clLien);
/*  68 */         g.drawLine(this.entite.getCentreX(), this.entite.getCentreY(), this.heritage.getCentreX(), this.heritage.getCentreY());
/*  69 */         if (this.heritage.getEntitePere() == this.entite) dessinerfleche(g);
/*  70 */         g.drawString(getNom(), (this.entite.getCentreX() + this.heritage.getCentreX()) / 2 + 2, (this.entite.getCentreY() + this.heritage.getCentreY()) / 2 - 2);
/*     */       }
/*     */       
/*     */     }
...
/*  77 */       if (this.heritage.getEntitePere() == this.entite) dessinerfleche(g);
/*  78 */       g.drawLine(this.heritage.getCentreX(), this.heritage.getCentreY(), (int)this.xCassure, (int)this.yCassure);
...
/*  85 */       if (this.heritage.getEntitePere() == this.entite) dessinerfleche(g);
/*  86 */       g.drawLine(this.heritage.getCentreX(), this.heritage.getCentreY(), (int)this.xCassure, (int)this.yCassure);
...
/*     */   {
/* 239 */     if (!isCassure()) {
/* 240 */       int h = this.entite.getCentreY() - this.heritage.getCentreY();
/* 241 */       int w = this.entite.getCentreX() - this.heritage.getCentreX();
/* 242 */       if ((Math.abs(w) < 10) && (
/* 243 */         ((this.entite.getCentreX() >= x) && (this.heritage.getCentreX() <= x)) || ((this.entite.getCentreX() <= x) && (this.heritage.getCentreX() >= x))))
/*     */       {
/* 245 */         if (((this.entite.getCentreY() >= y) && (this.heritage.getCentreY() <= y)) || ((this.entite.getCentreY() <= y) && (this.heritage.getCentreY() >= y)))
/*     */         {
/* 247 */           return true;
/*     */         }
/*     */       }
...
/*     */       
/*     */ 
/* 264 */       h = (int)this.yCassure - this.heritage.getCentreY();
/* 265 */       w = (int)this.xCassure - this.heritage.getCentreX();
/* 266 */       if ((Math.abs(w) < 10) && (
/* 267 */         (((int)this.xCassure >= x) && (this.heritage.getCentreX() <= x)) || (((int)this.xCassure <= x) && (this.heritage.getCentreX() >= x))))
/*     */       {
/* 269 */         if ((((int)this.yCassure >= y) && (this.heritage.getCentreY() <= y)) || (((int)this.yCassure <= y) && (this.heritage.getCentreY() >= y)))
/*     */         {
/* 271 */           return true;
/*     */         }
/*     */       }
...
/*     */     
/* 289 */     if (!isCassure()) {
/* 290 */       if ((this.entite.getCentreX() - this.heritage.getCentreX() > -6) && (this.entite.getCentreX() - this.heritage.getCentreX() < 6) && 
/* 291 */         (x > this.entite.getCentreX()) && (x < this.heritage.getCentreX())) {
...
/*     */   {
/* 329 */     if (this.entite.getCentreX() != this.heritage.getCentreX()) {
/* 330 */       if ((this.entite.getCentreX() <= x) && (this.heritage.getCentreX() >= x)) return true;
/* 331 */       if ((this.entite.getCentreX() >= x) && (this.heritage.getCentreX() <= x)) return true;
/*     */     } else {
/* 333 */       if ((this.entite.getCentreY() <= y) && (this.heritage.getCentreY() >= y)) return true;
/* 334 */       if ((this.entite.getCentreY() >= x) && (this.heritage.getCentreY() <= y)) return true;
/*     */     }
/* 336 */     return false;
/*     */   }
/*     */   
...
/* 351 */     if (this.xCassure != this.heritage.getCentreX()) {
/* 352 */       if ((this.xCassure <= x) && (this.heritage.getCentreX() >= x)) return true;
/* 353 */       if ((this.xCassure >= x) && (this.heritage.getCentreX() <= x)) return true;
/*     */     } else {
/* 355 */       if ((this.yCassure <= y) && (this.heritage.getCentreY() >= y)) return true;
/* 356 */       if ((this.yCassure >= x) && (this.heritage.getCentreY() <= y)) return true;
/*     */     }
/* 358 */     return false;
/*     */   }
/*     */   
/*     */   private double calculeA() {
/* 362 */     if (this.entite.getCentreX() - this.heritage.getCentreX() != 0) {
/* 363 */       double n = (this.entite.getCentreY() - this.heritage.getCentreY()) / (this.entite.getCentreX() - this.heritage.getCentreX());
/* 364 */       return n;
/*     */     }
...
/* 370 */     if (this.xCassure - this.heritage.getCentreX() != 0.0D) {
/* 371 */       double n = (this.yCassure - this.heritage.getCentreY()) / (this.xCassure - this.heritage.getCentreX());
/* 372 */       return n;
/*     */     }
...
/* 386 */     if (this.entite.getCentreX() - this.heritage.getCentreX() != 0) {
...
/* 402 */     if (this.xCassure - this.heritage.getCentreX() != 0.0D) {
...
/* 422 */       if ((this.entite.getCentreX() < this.heritage.getCentreX()) && (this.entite.getCentreY() < this.heritage.getCentreY())) {
...
/*     */         }
/*     */       }
/* 440 */       if ((this.entite.getCentreX() > this.heritage.getCentreX()) && (this.entite.getCentreY() < this.heritage.getCentreY())) {
...
/*     */         }
/*     */       }
/* 458 */       if ((this.entite.getCentreX() > this.heritage.getCentreX()) && (this.entite.getCentreY() > this.heritage.getCentreY())) {
...
/*     */         }
/*     */       }
/* 476 */       if ((this.entite.getCentreX() < this.heritage.getCentreX()) && (this.entite.getCentreY() > this.heritage.getCentreY())) {
...
/*     */         }
/*     */       }
/* 494 */       if (this.entite.getCentreX() == this.heritage.getCentreX()) {
/* 495 */         if (this.entite.getCentreY() > this.heritage.getCentreY()) {
...
/*     */         }
/*     */       }
/* 505 */       if (this.entite.getCentreY() == this.heritage.getCentreY()) {
/* 506 */         if (this.entite.getCentreX() > this.heritage.getCentreX()) {
...
/*     */   }
/*     */   
/*     */   public IhmHeritage getHeritage() {
/* 640 */     return this.heritage;
/*     */   }
/*     */   
...
/*     */   }
/*     */   
/*     */   public void setHeritage(IhmHeritage heritage) {
/* 648 */     this.heritage = heritage;
/*     */   }
/*     */   
...
/* Location:              D:\Alexis\Desktop\JMerise\JMerise05\JMerise.jar!\IhmMCD\IhmLienContrainteHeritage.class
